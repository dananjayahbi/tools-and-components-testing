      ...
      <div className="login-container container">
        <div className="left">
          ...
          <p className="intro form-label">
            This is a plain dashboard template for future use ! <br/> (Uname: admin , Password: admin@1234)
          </p>
        </div>
        <div className="right">
          <Formik
          ...
          >
            <Form className="login-form">
              <div className="login-lead">Sign In to the Dashboard</div>
              ...
              <SubmitButton
                style={{
                  ...
                  width: "100%",
                  padding: "10px",
                  backgroundColor: "#208700",
                  color: "var(--white)",
                  border: "1px solid #208700",
                  "&:hover": {
